                ...
                <div id="wrap2">
                    <div id="wrap1">
                        ...
                        <div id="content">
                            ...
                            <div class="header">
                                <div class="title">
                                    <span>Send message (GCM) for <a href="/admin/profile.php/?id=<?php echo $accountInfo['id']; ?>"><?php echo $accountInfo['username']; ?></a></span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="/admin/personal_gcm.php/?id=<?php echo $accountId; ?>" class="support_wrap">
                            ...
                            <div class="header" style="margin-top: 30px;">
                                <div class="title">
                                    <span>Recently personal messages sent to the user</span>
                                </div>
                            </div>
